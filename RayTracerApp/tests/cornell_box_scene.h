...
#ifndef RAYTRACER_CORNELL_BOX_SCENE_H
#define RAYTRACER_CORNELL_BOX_SCENE_H
...
namespace Scene
{
    ...
    public:
        Object::HittableList GetWorld() override
        {
            ...
            auto light = std::make_shared<Materials::Light::DiffuseLight>(Color(15, 15, 15));

            objects.Add(std::make_shared<BVH::XZRect>(0, 555, 0, 555, 555, green));
            objects.Add(std::make_shared<BVH::YZRect>(0, 555, 0, 555, 0, red));
            objects.Add(std::make_shared<BVH::XZRect>(213, 343, 227, 332, 554, light));
            ...
            std::shared_ptr<Object::Hittable> box1 = std::make_shared<Object::Box>(Point3(0, 0, 0), Point3(165, 330,
                                                                                                          165),
                                                                              white);
